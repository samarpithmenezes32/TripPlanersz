...
export default function Home() {
  const [step, setStep] = useState(0); // 0: old logo, 1: arc+plane, 2: Tripzy logo, 3: text
    ...
    >
      ...
      >
        ...
        >
          ...
          <motion.image
            href="/logo.png" // Make sure this file exists in your public folder
            x="45"
            y="350"
            width="200"
            height="200"
      ...
      <AnimatePresence>
        {showSecond && (
          ...
          >
            <h2 className="text-2xl font-bold">What's new in Tripzy?</h2>
            <AnimatedListDemo />
          </motion.article>
        )}
      </AnimatePresence>
      <SparklesText className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 pointer-events-none">
        Tripzy
      </SparklesText>
    </motion.section>
